...
class Ui_DensiteDialogBase(object):
    def setupUi(self, DensiteDialogBase):
        ...
        DensiteDialogBase.resize(587, 766)
        ...
        self.lienCheminImport = QtWidgets.QLineEdit(self.tab)
        ...
        self.boutonCheminImport = QtWidgets.QPushButton(self.tab)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.boutonImport = QtWidgets.QPushButton(self.tab)
        ...
        self.generateurCouche = QtWidgets.QWidget()
        self.generateurCouche.setObjectName("generateurCouche")
        self.horizontalLayout_18 = QtWidgets.QHBoxLayout(self.generateurCouche)
        ...
        self.boutonIntegrationCommune = QtWidgets.QPushButton(self.generateurCouche)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.label_16 = QtWidgets.QLabel(self.generateurCouche)
        font = QtGui.QFont()
        font.setPointSize(7)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.comboBox_tb_commune = QtWidgets.QComboBox(self.generateurCouche)
        self.comboBox_tb_commune.setMinimumSize(QtCore.QSize(120, 0))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.label_10 = QtWidgets.QLabel(self.generateurCouche)
        font = QtGui.QFont()
        ...
        self.boutonCreationTb = QtWidgets.QPushButton(self.generateurCouche)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.line_3 = QtWidgets.QFrame(self.generateurCouche)
        self.line_3.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_3.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_3.setObjectName("line_3")
        self.verticalLayout_3.addWidget(self.line_3)
        self.line = QtWidgets.QFrame(self.generateurCouche)
        self.line.setFrameShape(QtWidgets.QFrame.HLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.verticalLayout_3.addWidget(self.line)
        self.line_2 = QtWidgets.QFrame(self.generateurCouche)
        ...
        self.RafraichirUi = QtWidgets.QPushButton(self.generateurCouche)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.label_8 = QtWidgets.QLabel(self.generateurCouche)
        font = QtGui.QFont()
        font.setPointSize(7)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.comboBox_tb_OCS = QtWidgets.QComboBox(self.generateurCouche)
        self.comboBox_tb_OCS.setMinimumSize(QtCore.QSize(120, 0))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.label_Commune = QtWidgets.QLabel(self.generateurCouche)
        font = QtGui.QFont()
        font.setPointSize(7)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.comboBoxChampsCode_12 = QtWidgets.QComboBox(self.generateurCouche)
        ...
        self.boutonIntegrationBd = QtWidgets.QPushButton(self.generateurCouche)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.line_6 = QtWidgets.QFrame(self.generateurCouche)
        self.line_6.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_6.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_6.setObjectName("line_6")
        self.gridLayout_3.addWidget(self.line_6, 4, 0, 1, 1)
        self.line_5 = QtWidgets.QFrame(self.generateurCouche)
        self.line_5.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_5.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_5.setObjectName("line_5")
        self.gridLayout_3.addWidget(self.line_5, 2, 0, 1, 1)
        self.line_4 = QtWidgets.QFrame(self.generateurCouche)
        ...
        self.label_Commune_6 = QtWidgets.QLabel(self.generateurCouche)
        font = QtGui.QFont()
        font.setPointSize(7)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.horizontalLayout_19.addWidget(self.label_Commune_6)
        self.comboBoxChampsNom = QtWidgets.QComboBox(self.generateurCouche)
        ...
        self.horizontalLayout_19.addWidget(self.comboBoxChampsNom)
        spacerItem26 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_19.addItem(spacerItem26)
        self.label_Commune_7 = QtWidgets.QLabel(self.generateurCouche)
        font = QtGui.QFont()
        font.setPointSize(7)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.comboBoxChampsInsee = QtWidgets.QComboBox(self.generateurCouche)
        ...
        self.label_19 = QtWidgets.QLabel(self.generateurCouche)
        font = QtGui.QFont()
        font.setPointSize(7)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.comboBoxChampsPopulation = QtWidgets.QComboBox(self.generateurCouche)
        self.comboBoxChampsPopulation.setMinimumSize(QtCore.QSize(120, 0))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.comboBoxChampsPopulation.setFont(font)
        self.comboBoxChampsPopulation.setObjectName("comboBoxChampsPopulation")
        self.comboBoxChampsPopulation.addItem("")
        self.comboBoxChampsPopulation.setItemText(0, "")
        self.horizontalLayout_19.addWidget(self.comboBoxChampsPopulation)
        self.gridLayout_3.addLayout(self.horizontalLayout_19, 6, 0, 1, 1)
        self.horizontalLayout_18.addLayout(self.gridLayout_3)
        self.tabWidget.addTab(self.generateurCouche, "")
        self.tab_remplacem_renforcem = QtWidgets.QWidget()
        self.tab_remplacem_renforcem.setObjectName("tab_remplacem_renforcem")
        self.gridLayout_13 = QtWidgets.QGridLayout(self.tab_remplacem_renforcem)
        ...
        self.rafraichirUi_Tout_Rafraichir = QtWidgets.QPushButton(self.tab_remplacem_renforcem)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.rafraichirUi_Tout_Rafraichir.sizePolicy().hasHeightForWidth())
        self.rafraichirUi_Tout_Rafraichir.setSizePolicy(sizePolicy)
        self.rafraichirUi_Tout_Rafraichir.setObjectName("rafraichirUi_Tout_Rafraichir")
        self.horizontalLayout_25.addWidget(self.rafraichirUi_Tout_Rafraichir)
        self.verticalLayout_4.addLayout(self.horizontalLayout_25)
        self.label_2 = QtWidgets.QLabel(self.tab_remplacem_renforcem)
        font = QtGui.QFont()
        font.setPointSize(7)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.comboBox_Stat = QtWidgets.QComboBox(self.tab_remplacem_renforcem)
        ...
        self.tableWidget_ChoixFinal_Stat = QtWidgets.QTableWidget(self.tab_remplacem_renforcem)
        ...
        self.rafraichirUi_ToutSupprimer = QtWidgets.QPushButton(self.tab_remplacem_renforcem)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.exportStat = QtWidgets.QPushButton(self.tab_remplacem_renforcem)
        self.exportStat.setEnabled(False)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_13.addLayout(self.horizontalLayout_34, 1, 0, 1, 1)
        self.tabWidget.addTab(self.tab_remplacem_renforcem, "")
    ...
    def retranslateUi(self, DensiteDialogBase):
        ...
        self.label_14.setText(_translate("DensiteDialogBase", "Indiquez simplément le repertoire dans lequel se trouve les fichiers GraceTHD"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("DensiteDialogBase", "1. IMPORTER DANS QGIS"))
        ...
        self.label_8.setText(_translate("DensiteDialogBase", "<html><head/><body><p align=\"justify\"><span style=\" font-family:\'Sans Serif\';\">Shpa OCS</span><span style=\" font-family:\'Sans Serif\'; font-size:10pt; color:#ff0000;\"> *</span></p></body></html>"))
        ...
        self.label_Commune_6.setText(_translate("DensiteDialogBase", "<html><head/><body><p align=\"justify\"><span style=\" font-family:\'Sans Serif\';\">Nom </span><span style=\" font-family:\'Sans Serif\'; font-size:10pt; color:#ff0000;\">*</span></p></body></html>"))
        self.label_Commune_7.setText(_translate("DensiteDialogBase", "<html><head/><body><p align=\"justify\"><span style=\" font-family:\'Sans Serif\';\">INSEE </span><span style=\" font-family:\'Sans Serif\'; font-size:10pt; color:#ff0000;\">*</span></p></body></html>"))
        self.label_19.setText(_translate("DensiteDialogBase", "<html><head/><body><p align=\"justify\"><span style=\" font-family:\'Sans Serif\';\">Population</span><span style=\" font-family:\'Sans Serif\'; font-size:10pt; color:#ff0000;\"> *</span></p></body></html>"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.generateurCouche), _translate("DensiteDialogBase", "2. INTEGRATION BD"))
        self.rafraichirUi_Tout_Rafraichir.setText(_translate("DensiteDialogBase", "Rafraichir"))
        ...
        item.setText(_translate("DensiteDialogBase", "Valeurs de filtre"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_remplacem_renforcem), _translate("DensiteDialogBase", "3. Statistiques"))
